          ...
          {Object.entries(
            ...
            <div key={date}>
              <div className="flex justify-center my-2">
                <span className="bg-gray-200 text-gray-700 text-sm px-3 py-1 rounded-full shadow">
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-right text-xs opacity-70">
                     ...
                     <p className={`flex justify-end text-xs opacity-70 ${message.to_user_id !== user._id
                        ? "hidden"
                        : "" } `}>
                      {<CheckCheck color={`${message.seen === true
                        ? "blue"
                        : "gray" } `} size={18}/>}
                      </p>
                  </div>
