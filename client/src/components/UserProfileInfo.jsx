  ...
  return (
    <div className="relative py-4 px-6 md:px-8 bg-white">
      <div className="flex flex-col items-start md:flex-row gap-6">
        <div className="w-32 h-32 profile-pic-layout border-4 border-white shadow-lg absolute -top-16 rounded-full">
          <img src={user.profile_picture} alt="" className="absolute rounded-full z-2 w-[100%] h-[100%]" />
        </div>
        ...
        <div className="w-full pt-16 ">
          <div className="flex flex-col md:flex-row items-start justify-between">
            ...
            {/* If user is not on others profile that means he is opening his profile so we will give edit buttons */}

            {
              !profileId && 
              <button onClick={()=>setShowEdit(true)} className="flex items-center gap-2 border border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-;g font-medium transition-colors mt-4 md:mt-0 cursor-pointer">
