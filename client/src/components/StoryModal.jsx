...
const StoryModal = ({setShowModal, fetchStories}) => {
  const bgColors = ["#4f46e5", "#7c3aed", "#db2777", "#e11d48", "#ca8a04", "#0d9488",   "#000000",      "#FF0000", "#008000", "#0000FF", "#FF00FF", "#808080", "#FFA500",  "#23272A", "#3C3F41",   ]
...
<div className="fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex justify-center p-4 overflow-y-auto items-start pt-6">
  <div className="w-full max-w-md">
    <div className='text-center mb-4 flex items-center justify-between'>
      <button onClick={() => setShowModal(prev => !prev)} className='text-white p-2 cursor-pointer'>
        <ArrowLeft />
      </button>
